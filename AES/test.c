...
static void test_encrypt_cbc_and_decrypt_cbc(void);
...
static void test_encrypt_cbc_and_decrypt_cbc(void)
{
    ...
    uint8_t iv[] = {0x60, 0xf3, 0xee, 0x2c, 0xf4, 0x61, 0x0e, 0x3c, 0xa8, 0x33, 0x79, 0x4f, 0x14, 0x2c, 0x7d, 0x71};
    uint8_t in[]  = {0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a};
    uint8_t buffer[16];
    int i;
    ...
    for(i=0; i<16; i++)
        printf("%02x", in[i]);
    AES_CBC_encrypt(in, key, buffer, 16,iv);
    printf("\n");
    AES_CBC_decrypt(buffer, key,in,16,iv);
...
static void test_encrypt_ctr_and_decrypt_ctr(void)
{
    ...
    AES_CTR_encrypt(in, key, buffer, 16,iv);
    printf("\n");
    AES_CTR_decrypt(buffer,key,in,16,iv);
